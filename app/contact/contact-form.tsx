...
export function ContactForm() {
  ...
  if (sent) return (
    <div className="p-8 md:p-10 rounded-3xl border border-line-soft bg-canvas">
      ...
      <h3 className="font-display text-2xl font-semibold mt-4">Message received.</h3>
      <p className="prose-lede mt-3 max-w-md">Thank you — we&apos;ll reply within one business day.</p>
    </div>
  );
  return (
    <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="p-6 md:p-8 rounded-3xl border border-line-soft bg-white space-y-5">
      ...
      <div>
        ...
        <div className="mt-2 flex gap-2 flex-wrap">
          {[{ id: "general", label: "General" }, { id: "membership", label: "Membership question" }, { id: "press", label: "Press" }, { id: "partner", label: "Partnership" }].map((t) => (
